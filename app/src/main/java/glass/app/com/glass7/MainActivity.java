...
public class MainActivity extends Activity
{
    ...
    //final String upLoadServerUri = BuildConfig.SERVER_ADDR + "/api/api_upload_translation.php";
    final String upLoadServerUri = BuildConfig.SERVER_ADDR + "/api/api_upload_translation.php";
    String picturePath;
    ...
    public void SendQueryString() {
        new Thread() {
            public void run() {
                ...
                String url = BuildConfig.SERVER_ADDR + "/api/api_set_location.php?app_set_location_lat="+
    ...
    public void sendToServer()
    {
        ...
        //final String uploadFileName = "te.txt";
        //final String uploadFileName = "2.jpg";
        //upLoadServerUri = BuildConfig.SERVER_ADDR + "/api/api_upload.php";
    ...
    public int uploadFile(String sourceFileUri) {
        ...
        //File sourceFile = new File("Users/xyzuser/Downloads/te.txt");
